// Central place for outbound links / package identity.
// BRAND is the display name; PACKAGE is the real npm identifier (lowercase,
...
export const SITE_URL = 'https://mailman.indianic.in';
